...
all: ledtest buttontest buzzertest fndtest textlcdtest colorledtest accelMagGyrotest
...
libMyPeri.a : led.o button.o buzzer.o fnd.o textlcd.o colorled.o accelMagGyro.o
	$(AR) rc libMyPeri.a led.o button.o buzzer.o fnd.o textlcd.o colorled.o accelMagGyro.o
